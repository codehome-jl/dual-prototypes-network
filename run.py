...
class Learner:
    ...
    def init_model(self):
        ...
        elif self.args.method == "mutil":
            model = CNN_Mutildimension(self.args)
        elif self.args.method == "pro":
            model = CNN_Pro(self.args)
    ...
    def parse_command_line(self):
        ...
        parser.add_argument('--val_iters', type=int, default=5000, help='iterations to val at.')
        parser.add_argument("--num_val_tasks", type=int, default=10000, help="number of random tasks to val on.")
    ...
    def run(self):
        ...
        for task_dict in self.video_loader:
            if iteration >= total_iterations:
                break
            iteration += 1
            print("===start===={}times".format(iteration))
    ...
    def train_task(self, task_dict):
        ...
        target_labels = task_dict['target_labels'].type(torch.LongTensor).to(self.device)
